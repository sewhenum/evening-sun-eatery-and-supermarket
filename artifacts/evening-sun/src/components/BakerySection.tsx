...
const bakeryItems = [
  ...
  { id: 'bk2', name: 'Evening Sun Special Bread', price: 500, description: 'Our signature dense and stretchy Nigerian bread, baked fresh daily.', image: 'https://images.unsplash.com/photo-1598373182133-52452f7691ef?w=1200?w=800&q=80q=100?w=800&q=80auto=format?w=800&q=80fit=crop', category: 'Bread' },
  ...
  { id: 'bk6', name: 'Glazed Doughnuts', price: 400, description: 'Soft, airy rings of joy with a sweet glaze.', image: 'https://images.unsplash.com/photo-1551024601-bec78aea704b?w=1200?w=800&q=80q=100?w=800&q=80auto=format?w=800&q=80fit=crop', category: 'Sweet' },
  { id: 'bk7', name: 'Chocolate Muffins', price: 500, description: 'Double chocolate muffins loaded with chocolate chips.', image: 'https://images.unsplash.com/photo-1607958996333-41aef7caefaa?w=1200?w=800&q=80q=100?w=800&q=80auto=format?w=800&q=80fit=crop', category: 'Sweet' },
  { id: 'bk8', name: 'Custom Cake (Deposit)', price: 15000, description: 'Deposit for birthday or wedding cakes. We will contact you.', image: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=1200?w=800&q=80q=100?w=800&q=80auto=format?w=800&q=80fit=crop', category: 'Cakes' },
];
