...
const bakeryItems = [
  ...
  { id: 'bk2', name: 'Evening Sun Special Bread', price: 500, description: 'Our signature dense and stretchy Nigerian bread, baked fresh daily.', image: 'https://images.unsplash.com/photo-1598373182133-52452f7691ef?w=800&q=80', category: 'Bread' },
  { id: 'bk9', name: 'Milk Bread', price: 600, description: 'Pillowy soft bread enriched with creamy milk for a rich, tender crumb.', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=800&q=80', category: 'Bread' },
  { id: 'bk10', name: 'Sardine Bread', price: 700, description: 'Savory bread stuffed with a well-seasoned sardine filling — a Nigerian classic.', image: 'https://images.unsplash.com/photo-1586444248902-2f64eddc13df?w=800&q=80', category: 'Bread' },
  { id: 'bk11', name: 'Coconut Bread', price: 650, description: 'Lightly sweetened bread baked with real coconut for a tropical, fragrant bite.', image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=800&q=80', category: 'Bread' },
