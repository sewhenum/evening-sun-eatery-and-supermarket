...
const menuItems = [
  ...
  { id: 'b1', name: 'Double Smash Burger', price: 5000, description: 'Two smashed beef patties, melted cheese, signature sauce.', image: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=1200?w=800&q=80q=100?w=800&q=80auto=format?w=800&q=80fit=crop', category: 'Burgers' },
  { id: 'b2', name: 'Cheese Burger', price: 4500, description: 'Juicy beef patty loaded with melted cheddar, lettuce, tomato, and our special burger sauce.', image: 'https://images.unsplash.com/photo-1553979459-d2229ba7433b?w=1200?w=800&q=80q=100?w=800&q=80auto=format?w=800&q=80fit=crop', category: 'Burgers' },
  { id: 'b3', name: 'Chicken Burger', price: 4000, description: 'Crispy fried or grilled chicken fillet with coleslaw, pickles, and mayo in a toasted bun.', image: 'https://images.unsplash.com/photo-1606755962773-d324e0a13086?w=1200?w=800&q=80q=100?w=800&q=80auto=format?w=800&q=80fit=crop', category: 'Burgers' },
  ...
  { id: 'p2', name: 'Meat Feast', price: 7000, description: 'Pepperoni, beef, chicken, sausages on a rich tomato base.', image: 'https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?w=1200?w=800&q=80q=100?w=800&q=80auto=format?w=800&q=80fit=crop', category: 'Pizza' },
  ...
  { id: 'd1', name: 'Chapman', price: 1200, description: 'Classic Nigerian mocktail with a hint of Angostura bitters.', image: 'https://images.unsplash.com/photo-1536935338788-846bb9981813?w=1200?w=800&q=80q=100?w=800&q=80auto=format?w=800&q=80fit=crop', category: 'Drinks' },
  { id: 'd2', name: 'Soft Drinks', price: 500, description: 'Chilled Coke, Fanta, Sprite, Pepsi, and more — pick your favourite fizzy refresher.', image: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=1200?w=800&q=80q=100?w=800&q=80auto=format?w=800&q=80fit=crop', category: 'Drinks' },
  { id: 'd3', name: 'Fruit Smoothie', price: 1500, description: 'Freshly blended seasonal fruits — mango, strawberry, banana, or mixed berry. Rich and chilled.', image: 'https://images.unsplash.com/photo-1553530666-ba11a7da3888?w=1200?w=800&q=80q=100?w=800&q=80auto=format?w=800&q=80fit=crop', category: 'Drinks' },
];
